...
<DocsButtons externalDoc="https://base-ui.com/react/components/button" />
...
This can be achieved by using the `render` prop to render a custom element and pass the `nativeButton` prop as `false`.
