...
.dark {
  ...
  --subtle: oklch(0.9349 0.004 286.32);
  ...
  --card-gradient: linear-gradient(
    ...
    oklch(0.2219 0.0042 264.48) 100%
  );
  ...
  --gradient-primary-hover: linear-gradient(
    180deg,
    oklch(0.6472 0.1671 263.71) 0%,
    oklch(0.6017 0.193 263.25) 100%
  );
...
@theme inline {
  ...
  --radius: 0.75rem;
  --shadow: 0 3px 4px rgba(0, 0, 0, 0.07);
