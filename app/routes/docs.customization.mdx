...
A guide to customizing the behavior of Selia components.
...
Below is a reference of the design tokens we use.
...
**Worth noting**: when using the render prop, some attributes—such as `data-slot`—may be overridden, which can affect the component’s 
[contextual styling](/docs/composition#2-contextual-styling).
