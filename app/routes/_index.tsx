...
export default function Index() {
  return (
    <>
      ...
      <div className="container mx-auto px-4 xl:px-28 pt-20 lg:pt-34">
        <div className="w-full lg:w-7/12 2xl:w-5/12">
          ...
          <h1 className="text-6xl/12 font-semibold tracking-tight bg-linear-to-b from-foreground to-foreground/60 bg-clip-text text-transparent">
            Interfaces That Feel Right, <br />
            Out of the Box
          </h1>
          <Text className="text-dimmed font-light text-2xl/7 mb-4 lg:w-9/12 mt-4">
          ...
          <div className="flex items-center mt-4 **:[svg]:w-8 gap-3 **:[svg]:grayscale **:[svg]:hover:grayscale-0 **:[svg]:transition-all">
            <Tooltip>
              <TooltipTrigger>
                <svg
