...
export const inputVariants = cva(
  [
    'h-9.5 px-3.5 w-full text-foreground rounded placeholder:text-dimmed transition-shadow transition-colors shadow-input',
    'ring ring-input-border hover:not-[[data-disabled]]:not-[:focus]:ring-input-accent-border focus:outline-none focus:ring-primary focus:ring-2',
