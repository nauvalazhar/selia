...
export function SidebarChat({ sidebarOpen, setSidebarOpen }: { sidebarOpen: boolean, setSidebarOpen: (open: boolean) => void }) {
  return (
    ...
    >
      <SidebarHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <Button className="lg:hidden" variant="plain" size="sm-icon" onClick={() => setSidebarOpen(!sidebarOpen)}>
      ...
      <SidebarContent render={<ScrollArea />}>
        <SidebarMenu>
          <SidebarGroup>
                ...
                <SidebarItem key={index}>
                  ...
                  <SidebarItemAction showOnHover>
                    <Menu>
                      ...
                      <MenuPopup className="w-42" size="compact">
                        <MenuItem>
                          <PinIcon />
                          Pin
                        </MenuItem>
